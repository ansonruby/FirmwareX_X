...
import Restablecer__Coneccion_Servidor
import Proceso_Actualizar_Firmware
...
#---------------------------------------------------------
#   Persmiso para el menu web
lib.Control_Web.Permisos_Web()
#---------------------------------------------------------
...
while 1:
    ...
    #---------------------------------------------------------
    #NOTA: Hacer actualizacion de firmware despues de actualizar usuarios
    Proceso_Actualizar_Firmware.Actualizar_Firmware("01:00 AM")     # 12:00 AM     03:59 PM 04:07 PM # hora chile  11:00 PM

    #---------------------------------------------------------
    # Proceso 7: Switch de Seguridad para dispositivos CCCB
    #---------------------------------------------------------

    if Serial.find("CCCD") != -1: #ID_Tratado = IDQ
        if Switch() == '1':
            #print 'Abierto'
            Borrar_BD()
    ...
    #---------------------------------------------------------
    Restablecer__Coneccion_Servidor.Restablecer(Hay_Internet)

    #---------------------------------------------------------
    # Proceso 9: panel web
    #---------------------------------------------------------
    lib.Control_Web.Comado_Web()
